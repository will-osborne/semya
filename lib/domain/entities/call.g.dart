...
_Call _$CallFromJson(Map<String, dynamic> json) => _Call(
  ...
  restartOffer: json['restartOffer'] as Map<String, dynamic>?,
  restartAnswer: json['restartAnswer'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$CallToJson(_Call instance) => <String, dynamic>{
  ...
  'restartOffer': instance.restartOffer,
  'restartAnswer': instance.restartAnswer,
